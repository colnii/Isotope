...
- `docs/controlled-terminal-execution-boundary-v0.2.md`
- `docs/real-terminal-backend-boundary-v0.2.md`
- `docs/terminal-backend-adapter-contract-v0.2.md`
- `docs/terminal-backend-selection-boundary-v0.2.md`
