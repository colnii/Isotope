...
本文把 `docs/docs-inventory.md` 的盘点结果转成可执行迁移计划。
...
Phase 1 当前 closed / paused。不要继续迁移 track docs、checkpoint docs、memory docs、kernel docs、`docs/current-status.md` 或 `docs/v0.2-roadmap.md`，除非用户明确请求下一批迁移。Kernel Gap Review 已在 `docs/kernel-gap-review-v0.2.md` 落地，Agent / Worker lifecycle boundary 已在 `docs/agent-worker-lifecycle-boundary-v0.2.md` 落地；默认下一阶段可进入对应 red tests 或 Workspace substrate boundary design。
...
- Keep `docs/current-status.md` and `docs/v0.2-roadmap.md` at their current paths through the first migration wave.
...
| --- | --- | --- | --- | --- | --- |
| `docs/README.md` | `docs/kernel/README.md` | kernel entrypoint | No | High | Current-truth reading order; old path needs stub. |
| `docs/action-type-registry-v0.1.md` | `docs/kernel/action-type-registry-v0.1.md` | kernel | No | Medium | Move with kernel docs. |
| `docs/approval-pause-resume-boundary-v0.2.md` | `docs/tracks/approval-pause-resume-boundary-v0.2.md` | track | No | High | Recently active Track E doc; keep until track links are stable. |
| `docs/artifact-content-read-policy-v0.2.md` | `docs/tracks/artifact-content-read-policy-v0.2.md` | track | No | High | Recently active Track C doc; keep until track links are stable. |
| `docs/checkpoint-history-fallback-v0.1.md` | `docs/checkpoint/checkpoint-history-fallback-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-history-index-retention-v0.1.md` | `docs/checkpoint/checkpoint-history-index-retention-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-history-save-boundary-v0.1.md` | `docs/checkpoint/checkpoint-history-save-boundary-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-history-save-integration-v0.1.md` | `docs/checkpoint/checkpoint-history-save-integration-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-integrity-v0.1.md` | `docs/checkpoint/checkpoint-integrity-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-migration-versioning-v0.1.md` | `docs/checkpoint/checkpoint-migration-versioning-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-ownership-v0.1.md` | `docs/checkpoint/checkpoint-ownership-v0.1.md` | checkpoint | No | High | Referenced by current checkpoint/status docs; needs stub. |
| `docs/checkpoint-retention-compaction-v0.1.md` | `docs/checkpoint/checkpoint-retention-compaction-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-save-trigger-v0.1.md` | `docs/checkpoint/checkpoint-save-trigger-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-schema-version-fields-v0.1.md` | `docs/checkpoint/checkpoint-schema-version-fields-v0.1.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/checkpoint-v0.1-scope-freeze.md` | `docs/checkpoint/checkpoint-v0.1-scope-freeze.md` | checkpoint | No | Medium | Move with checkpoint batch. |
| `docs/coding-plan-v0.1.md` | `docs/archive/coding-plan-v0.1.md` | archive | No | Low | Historical plan; move after active links checked. |
| `docs/commitment-levels.md` | `docs/kernel/commitment-levels.md` | kernel | No | Medium | Current reference; move with kernel batch. |
| `docs/current-status.md` | `docs/current-status.md` first; later `docs/status/current-status.md` | status entrypoint | No | High | Stable entrypoint; do not move in first migration. |
| `docs/deferred-boundary-review-v0.1.md` | `docs/tracks/deferred-boundary-review-v0.1.md` | track/status | No | High | Current deferred-surface reference; move with track docs. |
| `docs/demo-architecture-v0.1.md` | `docs/demo/demo-architecture-v0.1.md` | demo | Done | Low | Phase 1b completed; old path is a stub, new path holds the full doc. |
| `docs/demo-entrypoint-v0.1.md` | `docs/demo/demo-entrypoint-v0.1.md` | demo | Done | Low | Phase 1b completed; old path is a stub, new path holds the full doc. |
| `docs/demo-walkthrough-v0.1.md` | `docs/demo/demo-walkthrough-v0.1.md` | demo | Done | Low | Phase 1b completed; old path is a stub, new path holds the full doc. |
...
| `docs/event-prefix-digest-v0.1.md` | `docs/kernel/event-prefix-digest-v0.1.md` | kernel/checkpoint | No | Medium | Could go under kernel; referenced by checkpoint docs. |
| `docs/external-ingestion-boundary-v0.2.md` | `docs/tracks/external-ingestion-boundary-v0.2.md` | track | No | High | Recently active Track F doc; keep until external review links settle. |
| `docs/http-api-minimal-surface-v0.2.md` | `docs/tracks/http-api-minimal-surface-v0.2.md` | track | No | High | README / AGENTS link directly. |
| `docs/implementation-plan-v0.1.md` | `docs/archive/implementation-plan-v0.1.md` | archive | No | Low | Historical plan; move late. |
| `docs/kernel-architecture-v0.1.md` | `docs/kernel/kernel-architecture-v0.1.md` | kernel | No | High | Current reference; many docs mention it. |
| `docs/kernel-decision-log.md` | `docs/kernel/kernel-decision-log.md` | kernel | No | Medium | Move with kernel batch. |
| `docs/kernel-living-spec.md` | `docs/kernel/kernel-living-spec.md` | kernel | No | High | Current reference; keep stubs if moved. |
| `docs/kernel-one-pager.md` | `docs/kernel/kernel-one-pager.md` | kernel | No | Medium | Move with kernel batch. |
| `docs/kernel-spec-v0.1.md` | `docs/kernel/kernel-spec-v0.1.md` | kernel | No | High | Current reference; many docs mention it. |
| `docs/memory-record-persistence-boundary-v0.1.md` | `docs/memory/memory-record-persistence-boundary-v0.1.md` | memory | No | Medium | Move with memory batch. |
...
- compatibility stub files left at old paths
