...
- v0.2 demo acceptance 已落文档：`docs/demo/v0.2-demo-acceptance.md`。当前满足 `v0.2 developer demo` acceptance；`v0.2-demo` lightweight tag 已创建并推送，指向 `09319e7407116d9f99f4a18853d4df23a8714720`。GitHub Release 未发布；这是 developer demo tag，不是 product release。
...
12. `docs/demo/demo-entrypoint-v0.1.md` 已定义并实现 demo scope；`docs/demo/v0.1-demo-acceptance.md` 已将当前 demo accepted as developer demo：一个本地 module entrypoint 展示 deterministic kernel 闭环，不展示完整产品。
