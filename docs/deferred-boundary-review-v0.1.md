...
- Track E boundary doc 已落地：`docs/approval-pause-resume-boundary-v0.2.md`。它定义 approval pause / resolve / resume 的最小 kernel boundary；下一步是 red tests，不是完整 approval product implementation。
- 当前测试基线：`682 passed`。
...
- Track E: Minimal Approval Pause / Resume red tests；boundary doc 已落地在 `docs/approval-pause-resume-boundary-v0.2.md`。
