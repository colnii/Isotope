...
12. `docs/demo/demo-entrypoint-v0.1.md` 已定义并实现 demo scope；`docs/v0.1-demo-acceptance.md` 已将当前 demo accepted as developer demo：一个本地 module entrypoint 展示 deterministic kernel 闭环，不展示完整产品。
