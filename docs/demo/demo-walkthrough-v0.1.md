...
如果想先看流程图，见 `docs/demo/demo-architecture-v0.1.md`。那份图只解释 v0.1 demo runtime path，不是完整 Isotope 架构图。
...
当前 GitHub Actions smoke 使用 Python `3.12`，并通过 test extra 安装依赖：
