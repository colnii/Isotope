...
- Track D: Demo / Docs Polish has started with `docs/demo-walkthrough-v0.1.md` and `docs/demo-architecture-v0.1.md`
...
- continue Track D with README presentation polish / sample JSON, then Track A: HTTP API Minimal Surface design note / red tests
- 或停在当前稳定点
