...
- Capability Runner Thin Shell Closure Review 已落地，见 `docs/capability-runner-thin-shell-closure-review.md`。结论：first slice 足够 closed for now；不默认继续做 CLI / product hub / workflow engine，除非真实应用层调用暴露 friction。
