...
| `isotope-supervisor` | Codex Supervisor 命令行入口，支持扫描、建议面板、supervise 小闭环、定时汇报、变化触发、托管启动和发送指令 | 应用入口 | `src/isotope/features/supervisor/runner.py`, `apps/cli/isotope_supervisor.py` |
