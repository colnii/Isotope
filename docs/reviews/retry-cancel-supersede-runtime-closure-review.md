...
Follow-up status: boundary is now defined in `../architecture/event-schema-registry-compatibility-boundary-v0.2.md`; next suggested step is `Event Schema Registry / Compatibility Red Tests`.
