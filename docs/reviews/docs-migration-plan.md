...
| `../architecture/checkpoint-history-fallback-v0.1.md` | `docs/checkpoint/checkpoint-history-fallback-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-history-index-retention-v0.1.md` | `docs/checkpoint/checkpoint-history-index-retention-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-history-save-boundary-v0.1.md` | `docs/checkpoint/checkpoint-history-save-boundary-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
...
| `../architecture/checkpoint-integrity-v0.1.md` | `docs/checkpoint/checkpoint-integrity-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-migration-versioning-v0.1.md` | `docs/checkpoint/checkpoint-migration-versioning-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-ownership-v0.1.md` | `docs/checkpoint/checkpoint-ownership-v0.1.md` | checkpoint | No | High | Placement reviewed in `deferred-docs-placement-review.md`; high-risk path needs stub if moved. |
| `../architecture/checkpoint-retention-compaction-v0.1.md` | `docs/checkpoint/checkpoint-retention-compaction-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-save-trigger-v0.1.md` | `docs/checkpoint/checkpoint-save-trigger-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-schema-version-fields-v0.1.md` | `docs/checkpoint/checkpoint-schema-version-fields-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1-scope-freeze.md` | `docs/checkpoint/checkpoint-v0.1-scope-freeze.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
...
| `../architecture/memory-record-persistence-boundary-v0.1.md` | `docs/memory/memory-record-persistence-boundary-v0.1.md` | memory | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with memory batch. |
| `../architecture/memory-v0.1-scope-freeze.md` | `docs/memory/memory-v0.1-scope-freeze.md` | memory | No | High | Placement reviewed in `deferred-docs-placement-review.md`; current memory scope reference. |
| `../architecture/memory-write-query-boundary-v0.1.md` | `docs/memory/memory-write-query-boundary-v0.1.md` | memory | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with memory batch. |
...
| `../architecture/server-checkpoint-boundary-v0.1.md` | `docs/checkpoint/server-checkpoint-boundary-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
