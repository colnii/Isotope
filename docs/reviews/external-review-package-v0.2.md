...
2. `../current/status.md` for the authoritative current truth.
3. `app-spike-coverage-review.md` for what the app spikes actually pressure-tested.
4. `kernel-gap-review-refresh-v0.2.md` for what remains kernel-level vs product-level.
5. `../features/artifact-review-flow-closure-review.md` for the first app spike closure.
6. `../features/external-snapshot-review-closure-review.md` for the second app spike closure.
7. `../architecture/workspace-resource-lifecycle-closure-review.md` for workspace lifecycle read-model closure.
8. `../architecture/policy-registry-version-basis-closure-review.md` for registry/profile basis metadata closure.
9. `../architecture/event-schema-registry-closure-review.md` for event schema compatibility closure.
10. `../features/agent-loop-branch-handoff-checkpoint.md` for the branch-local Agent loop proof and stop point.
11. `../architecture/agent-loop-run-control-boundary-v0.2.md` for the product-facing Agent loop control read model.
12. `../architecture/agent-loop-step-driver-boundary-v0.2.md` for the one-step Agent loop driver.
...
- `retry-cancel-supersede-runtime-closure-review.md`
- `../architecture/agent-worker-lifecycle-boundary-v0.2.md`
- `../architecture/workspace-substrate-boundary-v0.2.md`
