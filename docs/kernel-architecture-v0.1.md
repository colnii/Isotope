...
- `ActionTypeRegistry` 已由 Action Compiler 消费用于 compact tool lookup；registry schema / 版本化仍未定，当前最小边界见 `docs/action-type-registry-v0.1.md`。
...
- `ActionTypeRegistry` 的 policy / executor integration、schema 和版本化；compiler lookup 已实现，当前最小边界见 `docs/action-type-registry-v0.1.md`。
