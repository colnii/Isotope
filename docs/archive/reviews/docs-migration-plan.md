...
historical plan（历史计划）归档；kernel 和 status placement reviews 已记录不移动
...
| `../architecture/kernel-v0.1/action-type-registry-v0.1.md` | `docs/kernel/action-type-registry-v0.1.md` | kernel | No | Medium | Move with kernel docs. |
| `../architecture/approval-pause-resume-boundary-v0.2.md` | `docs/tracks/approval-pause-resume-boundary-v0.2.md` | track | No | High | Placement reviewed in `deferred-docs-placement-review.md`; keep until track batch is explicitly reopened. |
| `../architecture/artifact-content-read-policy-v0.2.md` | `docs/tracks/artifact-content-read-policy-v0.2.md` | track | No | High | Placement reviewed in `deferred-docs-placement-review.md`; keep until track batch is explicitly reopened. |
| `../architecture/checkpoint-v0.1/checkpoint-history-fallback-v0.1.md` | `docs/checkpoint/checkpoint-history-fallback-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-history-index-retention-v0.1.md` | `docs/checkpoint/checkpoint-history-index-retention-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-history-save-boundary-v0.1.md` | `docs/checkpoint/checkpoint-history-save-boundary-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `checkpoint-history-save-integration-v0.1.md` | `docs/checkpoint/checkpoint-history-save-integration-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-integrity-v0.1.md` | `docs/checkpoint/checkpoint-integrity-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-migration-versioning-v0.1.md` | `docs/checkpoint/checkpoint-migration-versioning-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-ownership-v0.1.md` | `docs/checkpoint/checkpoint-ownership-v0.1.md` | checkpoint | No | High | Placement reviewed in `deferred-docs-placement-review.md`; high-risk path needs stub if moved. |
| `../architecture/checkpoint-v0.1/checkpoint-retention-compaction-v0.1.md` | `docs/checkpoint/checkpoint-retention-compaction-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-save-trigger-v0.1.md` | `docs/checkpoint/checkpoint-save-trigger-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-schema-version-fields-v0.1.md` | `docs/checkpoint/checkpoint-schema-version-fields-v0.1.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
| `../architecture/checkpoint-v0.1/checkpoint-v0.1-scope-freeze.md` | `docs/checkpoint/checkpoint-v0.1-scope-freeze.md` | checkpoint | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with checkpoint batch. |
...
| `deferred-boundary-review-v0.1.md` | `docs/tracks/deferred-boundary-review-v0.1.md` | track/status | No | High | Placement reviewed in `deferred-docs-placement-review.md`; move only with explicit track/status batch. |
...
| `../architecture/event-v0.1/event-envelope-schema-registry-v0.1.md` | `docs/kernel/event-envelope-schema-registry-v0.1.md` | kernel | No | Medium | Move with event docs. |
| `../architecture/event-v0.1/event-envelope-versioning-v0.1.md` | `docs/kernel/event-envelope-versioning-v0.1.md` | kernel | No | Medium | Move with event docs. |
| `../architecture/event-v0.1/event-prefix-digest-v0.1.md` | `docs/kernel/event-prefix-digest-v0.1.md` | kernel/checkpoint | No | Medium | Could go under kernel; referenced by checkpoint docs. |
| `../architecture/external-ingestion-boundary-v0.2.md` | `docs/tracks/external-ingestion-boundary-v0.2.md` | track | No | High | Placement reviewed in `deferred-docs-placement-review.md`; keep until track batch is explicitly reopened. |
| `../architecture/http-api-minimal-surface-v0.2.md` | `docs/tracks/http-api-minimal-surface-v0.2.md` | track | No | High | Placement reviewed in `deferred-docs-placement-review.md`; README / AGENTS link directly. |
...
| `../architecture/kernel-v0.1/kernel-architecture-v0.1.md` | `docs/kernel/kernel-architecture-v0.1.md` | kernel | No | High | Current reference; many docs mention it. |
...
| `../architecture/kernel-v0.1/kernel-living-spec.md` | `docs/kernel/kernel-living-spec.md` | kernel | No | High | Current reference; keep stubs if moved. |
...
| `../architecture/kernel-v0.1/kernel-spec-v0.1.md` | `docs/kernel/kernel-spec-v0.1.md` | kernel | No | High | Current reference; many docs mention it. |
| `../architecture/memory-v0.1/memory-record-persistence-boundary-v0.1.md` | `docs/memory/memory-record-persistence-boundary-v0.1.md` | memory | No | Medium | Placement reviewed in `deferred-docs-placement-review.md`; move only with memory batch. |
| `../architecture/memory-v0.1/memory-v0.1-scope-freeze.md` | `docs/memory/memory-v0.1-scope-freeze.md` | memory | No | High | Placement reviewed in `deferred-docs-placement-review.md`; current memory scope reference. |
