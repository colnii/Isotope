...
| `../features/demo-entrypoint-v0.1.md` | `../features/demo/demo-entrypoint-v0.1.md` | `../current/status.md`, `../architecture/memory-v0.1/memory-v0.1-scope-freeze.md`, `deferred-boundary-review-v0.1.md`, `../archive/docs-inventory-pre-reorg.md` | Low after Phase 1b | Stub removed in Phase 1d. |
