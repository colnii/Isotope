...
- checkpoint history / old-checkpoint fallback 边界见 `checkpoint-history-fallback-v0.1.md`。
- checkpoint history index / retention policy 边界见 `checkpoint-history-index-retention-v0.1.md`。
- checkpoint history save 边界见 `checkpoint-history-save-boundary-v0.1.md`。
- checkpoint history save integration 边界见 `../reviews/checkpoint-history-save-integration-v0.1.md`。
- checkpoint v0.1 scope freeze 见 `checkpoint-v0.1-scope-freeze.md`。
...
更完整的 history index / retention policy sketch 见 `checkpoint-history-index-retention-v0.1.md`。
