...
- controlled `terminal_exec` first slice, documented separately in `controlled-terminal-execution-boundary-v0.2.md`
- `InProcessServer.create_source_artifact(...)`
- `InProcessServer.submit_action(...)`
- `approval-tool-runner` / `artifact-review` demos

Closure review: `tool-protocol-closure-review.md`.
