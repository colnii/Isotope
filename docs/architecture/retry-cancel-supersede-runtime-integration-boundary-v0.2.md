...
- `../reviews/retry-cancel-supersede-runtime-closure-review.md`
...
- follow-up status: boundary is now defined in `event-schema-registry-compatibility-boundary-v0.2.md`; next suggested step is `Event Schema Registry / Compatibility Red Tests`
