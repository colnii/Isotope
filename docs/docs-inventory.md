...
- `docs/capability-search-launch-plan-boundary-v0.2.md`：Capability Search / Launch Plan boundary，记录 search / preflight / launch-plan output shape、no-side-effect rules、未来 LLM router 关系和 first red tests recommendation。
