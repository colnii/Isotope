...
from isotope_kernel import artifact_store, event_store, executor, models, terminal_backend, workspace
...
def test_transcript_diff_and_changed_files_are_artifacts_not_event_content(tmp_path):
    ...
    changed_files = "CHANGED_FILES_SECRET_src/isotope_kernel/file.py"
