...
from isotope import action_compiler, artifact_store, event_store, executor, policy, workspace
...
def test_isotope_does_not_import_x_agent():
    import pathlib

    root = pathlib.Path("src/isotope")
    offenders = []
