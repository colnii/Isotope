    ...
    def default(cls) -> "CapabilityCatalog":
        ...
        return cls(
            capabilities=list(itertools.chain(
                artifact_capability_definitions(Capability),
                coding_capability_definitions(Capability),
                workspace_capability_definitions(Capability),
                core_capability_definitions(Capability),
                memory_capability_definitions(Capability),
                screen_capability_definitions(Capability),
                research_capability_definitions(Capability),
                supervisor_capability_definitions(Capability),
            )))
