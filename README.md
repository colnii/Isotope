...
Capability Hub Core 的 mainline first slice 已实现，边界见 [docs/capability-hub-core-boundary-v0.2.md](docs/capability-hub-core-boundary-v0.2.md)：当前只抽取能力目录小核心，不整体合并 aggressive capability hub。
