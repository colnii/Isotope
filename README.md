...
- Capability Runner Thin Shell first slice: `isotope_kernel.capability_runner` can list/describe/status catalog capabilities and run three allowlisted deterministic product candidates without copying aggressive hub or constructing providers.
