...
- `v0.1-demo` and `v0.2-demo` developer demo tags exist; current branch-local baseline is pending rebase verification; pre-branch mainline baseline was `1064 passed`.
