...
- `v0.1-demo` and `v0.2-demo` developer demo tags exist; current non-packaging baseline on this Mac mini is `1016 passed, 8 deselected`; full regression still has 4 known local `test_packaging_smoke.py` ensurepip/temp venv bootstrap errors.
