...
- `v0.1-demo` and `v0.2-demo` developer demo tags exist; current integration baseline is `1374 passed, 5 skipped`; pre-controlled-terminal mainline baseline was `1134 passed`.
...
- Capability Runner Thin Shell closure review is documented in [docs/capability-runner-thin-shell-closure-review.md](docs/capability-runner-thin-shell-closure-review.md). Treat the first slice as closed for now; do not expand CLI / product hub / workflow engine unless real application-layer usage produces concrete friction.
