...
- Current Track E boundary doc: [docs/approval-pause-resume-boundary-v0.2.md](docs/approval-pause-resume-boundary-v0.2.md). Approval resolution plus run-state / HTTP read-model green slices are complete.
