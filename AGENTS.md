...
- `v0.1-demo` developer demo is accepted; baseline is `711 passed`.
...
- Current Track E boundary doc: [docs/approval-pause-resume-boundary-v0.2.md](docs/approval-pause-resume-boundary-v0.2.md). First approval resolution / HTTP approval green slice is complete.
