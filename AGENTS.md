...
- `v0.1-demo` and `v0.2-demo` developer demo tags exist; current baseline on this Mac mini is `1062 passed` when using the local `DYLD_LIBRARY_PATH` workaround documented in `/Users/infoxmde/openclaw-ops/state/isotope/local_env_note.md`.
