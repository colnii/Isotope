...
- Mainline batch automation is documented in [docs/agent-task-queue.md](docs/agent-task-queue.md). Current Batch is complete; do not start unlisted tracks or enter a new batch without an updated queue or explicit user instruction.
